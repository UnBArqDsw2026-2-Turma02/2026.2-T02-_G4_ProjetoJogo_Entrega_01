...
| Danilo Sarmento Barros | Compreendi a importância fundamental do compartilhamento contínuo de ideias e da comunicação constante entre os membros da equipe para manter o alinhamento das decisões de projeto. Além disso, aprofundei meus conhecimentos na notação BPMN 2.0, compreendendo a estruturação formal dos fluxos de processos e o particionamento de papéis e responsabilidades em raias. | A IA Generativa serviu como apoio no processo de ideação e na estruturação de textos e sínteses do grupo. No entanto, notou-se que a ferramenta exige constante validação humana e direcionamento crítico, pois gera soluções genéricas e pode desconsiderar regras de negócio específicas e restrições formais de modelagem BPMN. |
| João Vitor Mendonça Merlin | |  |
...
| Danilo Sarmento Barros | Preenchimento das lições aprendidas e reflexão crítica sobre o uso da IA Generativa | [Commits GitHub] | 27/08/2026 |