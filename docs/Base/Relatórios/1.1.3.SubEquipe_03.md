...
#### Processo principal - Fluxo geral de interação

<center>

<p style={{ textAlign: 'center', fontSize: '18px' }}><b>Figura 3</b> - Processo principal do BPMN</p>

![Processo principal do BPMN](INSERIR_CAMINHO_IMAGEM_PROCESSO_PRINCIPAL)
...
#### Subprocesso - Inserir nome do subprocesso

<center>

<p style={{ textAlign: 'center', fontSize: '18px' }}><b>Figura 4</b> - Inserir nome do subprocesso</p>

![Inserir nome do subprocesso](INSERIR_CAMINHO_IMAGEM_SUBPROCESSO_01)

<p style={{ textAlign: 'center', fontSize: '17px' }}>Autores: Eduardo Ribeiro, Gabriel Pereira, Guilherme Negreiros e Weverton Rodrigues</p>

</center>

Inserir uma breve explicação do subprocesso, descrevendo qual ação ou regra de comportamento ele representa, quais eventos iniciam o fluxo, quais decisões são tomadas e como o resultado retorna ao processo principal.

#### Subprocesso - Inserir nome do subprocesso

<center>

<p style={{ textAlign: 'center', fontSize: '18px' }}><b>Figura 5</b> - Inserir nome do subprocesso</p>

![Inserir nome do subprocesso](INSERIR_CAMINHO_IMAGEM_SUBPROCESSO_02)

<p style={{ textAlign: 'center', fontSize: '17px' }}>Autores: Eduardo Ribeiro, Gabriel Pereira, Guilherme Negreiros e Weverton Rodrigues</p>

</center>

Inserir uma breve explicação do subprocesso, destacando sua relação com as regras recuperadas na Engenharia Reversa e sua função dentro do cuidado, da navegação ou da evolução do pet virtual.

#### Subprocesso - Inserir nome do subprocesso

<center>

<p style={{ textAlign: 'center', fontSize: '18px' }}><b>Figura 6</b> - Inserir nome do subprocesso</p>

![Inserir nome do subprocesso](INSERIR_CAMINHO_IMAGEM_SUBPROCESSO_03)

<p style={{ textAlign: 'center', fontSize: '17px' }}>Autores: Eduardo Ribeiro, Gabriel Pereira, Guilherme Negreiros e Weverton Rodrigues</p>

</center>

Inserir uma breve explicação do subprocesso, indicando quais elementos BPMN foram utilizados, quais condições ou eventos afetam o fluxo e qual é o impacto dessa ação no estado do pet.

#### Subprocesso - Inserir nome do subprocesso

<center>

<p style={{ textAlign: 'center', fontSize: '18px' }}><b>Figura 7</b> - Inserir nome do subprocesso</p>

![Inserir nome do subprocesso](INSERIR_CAMINHO_IMAGEM_SUBPROCESSO_04)

<p style={{ textAlign: 'center', fontSize: '17px' }}>Autores: Eduardo Ribeiro, Gabriel Pereira, Guilherme Negreiros e Weverton Rodrigues</p>

</center>

Inserir uma breve explicação do subprocesso, relacionando a representação BPMN com o comportamento observado no Tamagotchi Gen 1 e com as abstrações adotadas pela equipe.
...
|[Guilherme Negreiros](https://github.com/guin409) | Alterações no GitHub Pages, incluindo ajustes nas evidências, atas, tabela de downloads, participantes e versionamento da SubEquipe 03. | [Inserir link do commit]() | 27/08/2026 |
