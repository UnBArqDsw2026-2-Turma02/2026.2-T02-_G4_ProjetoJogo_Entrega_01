...
|[Weverton Rodrigues](https://github.com/vevetin)| Documentação dos artefatos produzidos pela SubEquipe 03, com inclusão das imagens do Mapa Mental, do SIG/NFR Framework e dos modelos BPMN, acompanhadas de breves descrições explicativas de cada subprocesso. | - | 27/08/2026 |
|[Weverton Rodrigues](https://github.com/vevetin)| Adição do prompt e do relatório de Deep Research utilizados como apoio à pesquisa e à engenharia reversa do Tamagotchi Gen 1. | - | 27/08/2026 |
|[Eduardo Ribeiro](https://github.com/EduardoRGS)| Adição de lições aprendidas e uso de AI generativa. | - | 27/08/2026 |
|[Gabriel Pereira](https://github.com/bielg7)| Adição de lições aprendidas e uso de AI generativa. | - | 27/08/2026 |
